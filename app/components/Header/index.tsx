...
export const Header = () => {
  ...
  return (
    <>
      ...
      <div className={ clsx("fixed top-0 pt-10 px-5 md:px-10 right-0 z-50 lg:hidden" , menuOpen ? "text-white" : "text-black") }>
        <button
          onClick={ () => setMenuOpen(!menuOpen) }
          className={ "focus-outline mr-2 lg:hidden p-2 hover:text-hover sm:pl-0" }
